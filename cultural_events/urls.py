"""cultural_events URL Configuration
...
Function views
    ...
    2. Add a URL to urlpatterns:  path('', views.home, event_name='home')
Class-based views
    1. Add an import:  from other_app.views import Home
    2. Add a URL to urlpatterns:  path('', Home.as_view(), event_name='home')
